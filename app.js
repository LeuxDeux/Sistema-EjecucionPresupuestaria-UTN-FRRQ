...
const serviceAccount = require('./env/firebaseServiceAccountKey.json'); // Ruta a tu archivo JSON
admin.initializeApp({
    credential: admin.credential.cert(serviceAccount),
    storageBucket: 'sep-utnfrrq.appspot.com' // Reemplaza con tu bucket de Firebase
});
...
//     next();
// });
// Configuración de almacenamiento para Multer::::::Para volver a usar multer descomentar toda esta parte del código
